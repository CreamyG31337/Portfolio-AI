CREATE POLICY "Users can view portfolio positions for their funds" ON "portfolio_positions" FOR SELECT TO public USING ((((fund)::text IN ( SELECT user_funds.fund_name
   FROM user_funds
