-- Function: get_etf_holding_trades
-- Returns ETF buy/sell trades for a given holding ticker by comparing consecutive dates
-- Used by the ticker details price chart to show ETF activity markers
...
COMMENT ON FUNCTION get_etf_holding_trades IS 'Returns ETF buy/sell trades for a holding ticker by comparing consecutive dates. Used for ticker detail chart markers.';
