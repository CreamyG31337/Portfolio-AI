#!/usr/bin/env python3
"""Apply database/migrations/2026-08_add_social_available_at.sql.

Usage:
    python web_dashboard/scripts/apply_social_available_at_migration.py
...
MIGRATION_FILE = (
    _REPO_ROOT / "database" / "migrations" / "2026-08_add_social_available_at.sql"
)
...
def main() -> int:
    ...
    def status() -> dict[str, bool]:
        out: dict[str, bool] = {}
        for table, col in (
            ("social_metrics", "available_at"),
            ("social_posts", "available_at"),
        ):
    ...
    if missing:
        ...
        return 1
    print("Migration applied; social available_at columns present.")
    return 0
