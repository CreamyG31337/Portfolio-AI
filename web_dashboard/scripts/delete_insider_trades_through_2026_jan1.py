"""
Delete all insider_trades with transaction_date <= 2026-01-01 (Supabase).
Removes 2024, 2025, 2026-01-01 and any earlier rows.
...
def main() -> None:
    ...
    client.supabase.table("insider_trades").delete().lte(
        "transaction_date", "2026-01-01"
    ).execute()
    print("Deleted insider_trades rows with transaction_date <= 2026-01-01.")
